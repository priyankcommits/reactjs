...
var base = Rebase.createClass('https://reactjstut-ecd8a.firebaseio.com/');
...
var Fish = React.createClass({
	onButtonClicked : function(){
		console.log("Console to add fish: ", this.props.index);
	...
	render : function() {
		...
		return(
				<li className="menu-fish">
					...
					<p>{details.desc}</p>
					<button disabled={!isAvailable} onClick={this.onButtonClicked}>
					{buttonText}
					</button> 
				</li>
			)
